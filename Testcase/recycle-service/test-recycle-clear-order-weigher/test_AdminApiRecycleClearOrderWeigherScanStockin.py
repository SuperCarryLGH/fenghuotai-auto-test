...
class Test_AdminApiRecycleClearOrderWeigherScanStockin:
    ...
    def test_AdminApiRecycleClearOrderWeigherScanStockin(self, api_session, auth_headers, ok):
        url = f"{ADMIN_URL}/admin-api/recycle/app-clearOrder-weigher/scan-stockin"
