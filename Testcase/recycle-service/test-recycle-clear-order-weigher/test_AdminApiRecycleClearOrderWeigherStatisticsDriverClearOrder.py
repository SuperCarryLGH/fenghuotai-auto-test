...
class Test_AdminApiRecycleClearOrderWeigherStatisticsDriverClearOrder:
    ...
    @pytest.mark.smoke
    def test_AdminApiRecycleClearOrderWeigherStatisticsDriverClearOrder(self, weigher_ctx):
        chain, wt = weigher_ctx
        r = chain._get(f"{ADMIN_URL}/admin-api/recycle/app-clearOrder-weigher/statistics-driver-clear-order",
