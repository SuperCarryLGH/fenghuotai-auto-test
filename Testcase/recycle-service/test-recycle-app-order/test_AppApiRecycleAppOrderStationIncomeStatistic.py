...
class Test_AppApiRecycleAppOrderStationIncomeStatistic:
    ...
    @pytest.mark.smoke
    def test_AppApiRecycleAppOrderStationIncomeStatistic(self, api_session, auth_headers, ok):
        url = f"{ADMIN_URL}/admin-api/recycle/app-order/station-income-statistic"
