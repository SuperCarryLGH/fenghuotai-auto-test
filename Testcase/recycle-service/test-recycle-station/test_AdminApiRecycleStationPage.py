...
class Test_AdminApiRecycleStationPage:
    """admin回收站点分页"""

    @pytest.mark.smoke
    def test_AdminApiRecycleStationPage(self, api_session, auth_headers, ok):
        url = f"{ADMIN_URL}/admin-api/recycle/station/page"
        params = {
