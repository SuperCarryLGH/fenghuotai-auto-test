...
class Test_AdminApiRecycleStationClueVisitGet:
    """admin获取网点线索拜访记录"""
    ...
    @pytest.mark.smoke
    def test_AdminApiRecycleStationClueVisitGet(self, clue_chain, station_user_ctx, api_session, ok):
        ...
        url = f"{ADMIN_URL}/admin-api/recycle/station/clue-visit/get"
        ok(api_session.get(url, params={"id": self._created_id}, headers=b_headers))
