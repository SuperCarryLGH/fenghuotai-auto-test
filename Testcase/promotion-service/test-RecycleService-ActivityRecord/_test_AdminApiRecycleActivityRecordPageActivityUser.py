...
class Test_AdminApiRecycleActivityRecordPageActivityUser:
    """活动参与订单分页"""

    @pytest.mark.smoke
    def test_AdminApiRecycleActivityRecordPageActivityUser(self, api_session, auth_headers):
        url = f"{ADMIN_URL}/admin-api/recycle/activity-record/pageActivityUser"
        body ={
