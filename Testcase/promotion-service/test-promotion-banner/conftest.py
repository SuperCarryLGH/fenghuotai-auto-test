...
def autotest_banner_id(api_session, auth_headers):
    ...
    resp = api_session.post(f"{ADMIN_URL}/admin-api/promotion/banner/create", json=body, headers=auth_headers)
    ...
    api_session.delete(f"{ADMIN_URL}/admin-api/promotion/banner/delete", params={"id": rec_id}, headers=auth_headers)
