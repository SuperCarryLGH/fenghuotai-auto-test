...
class Test_AdminApiRecycleActivityReportExportExcel:
    """创建活动报告"""

    @pytest.mark.smoke
    def test_AdminApiRecycleActivityReportExportExcel(self, api_session, auth_headers):
        url = f"{ADMIN_URL}/admin-api/recycle/activity-report/export-excel"
        body = {
